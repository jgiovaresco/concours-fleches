package fr.egiov.concoursfleches.tapestry.services;
...
import fr.egiov.concoursfleches.tapestry.composants.InjectSelectionModelWorker;
...
public class AppModule
{
   ...
   {
      configuration.add("InjectSelectionModel", new InjectSelectionModelWorker(
            propertyAccess), "after:Inject*");
   }
    ...
    * inner class (as here) or require some other kind of special
